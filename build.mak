export PJDIR := /Users/dratek/work/sip/pjsip-xixi
...
export APP_CC := /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/llvm-gcc
export APP_CXX := /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/llvm-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O2 -Wno-unused-label -DPJ_SDK_NAME="\"iPhoneOS5.0.sdk\"" -arch armv7 -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	-O2 -arch armv7 -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -framework AudioToolbox -framework Foundation
export APP_LDLIBS := -lpjsua-$(TARGET_NAME)\
	...
	$(APP_THIRD_PARTY_EXT)\
	-lpj-$(TARGET_NAME)\
	-lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-O2 -Wno-unused-label -DPJ_SDK_NAME="\"iPhoneOS5.0.sdk\"" -arch armv7 -isysroot /Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
